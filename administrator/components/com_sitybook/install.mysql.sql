CREATE TABLE IF NOT EXISTS `#__sitybook_books` (
...
CREATE TABLE IF NOT EXISTS `#__sitybook_libraries` (
...
CREATE TABLE IF NOT EXISTS `#__sitybook_waitlists` (
...
CREATE TABLE IF NOT EXISTS `#__sitybook_wishlists` (
...
CREATE TABLE IF NOT EXISTS `#__sitybook_reviews` (
