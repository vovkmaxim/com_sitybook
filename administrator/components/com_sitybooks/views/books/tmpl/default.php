...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_sitybooks&task=books.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_sitybooks&view=books'); ?>" method="post" name="adminForm" id="adminForm">
