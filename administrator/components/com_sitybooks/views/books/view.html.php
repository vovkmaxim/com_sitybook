 ...
 */
class SitybooksViewBooks extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        SitybooksHelper::addSubmenu('books');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_SITYBOOKS_TITLE_BOOKS'), 'books.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/book';
        ...
        JHtmlSidebar::setAction('index.php?option=com_sitybooks&view=books');
